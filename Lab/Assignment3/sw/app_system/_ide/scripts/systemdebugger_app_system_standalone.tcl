...
# Path of this script: C:\File\Lec\graduate\AAA708-Microprocessor-based-Systems-Design\Lab\Assignment3\sw\app_system\_ide\scripts\systemdebugger_app_system_standalone.tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source C:\File\Lec\graduate\AAA708-Microprocessor-based-Systems-Design\Lab\Assignment3\sw\app_system\_ide\scripts\systemdebugger_app_system_standalone.tcl
# 
...
set bp_56_26_fsbl_bp [bpadd -addr &XFsbl_Exit]
con -block -timeout 60
bpremove $bp_56_26_fsbl_bp
targets -set -nocase -filter {name =~ "*R5*#0"}
rst -processor
