...
#define GPIO_BANK0_DATA0			GPIO_BANK0_BASE + 0x40
#define GPIO_BANK0_DIRM0			GPIO_BANK0_BASE + 0x204   // input or output
#define GPIO_BANK0_OEN0				GPIO_BANK0_BASE + 0x208   // output enable if configured as output
