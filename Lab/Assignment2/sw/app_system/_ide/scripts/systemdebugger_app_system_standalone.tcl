...
# Path of this script: C:\File\Lec\graduate\AAA708-Microprocessor-based-Systems-Design\Lab\Assignment2\sw\app_system\_ide\scripts\systemdebugger_app_system_standalone.tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source C:\File\Lec\graduate\AAA708-Microprocessor-based-Systems-Design\Lab\Assignment2\sw\app_system\_ide\scripts\systemdebugger_app_system_standalone.tcl
# 
...
fpga -file C:/File/Lec/graduate/AAA708-Microprocessor-based-Systems-Design/Lab/Assignment2/sw/app_2/_ide/bitstream/design_1_wrapper.bit
targets -set -nocase -filter {name =~"APU*"}
...
set bp_6_6_fsbl_bp [bpadd -addr &XFsbl_Exit]
con -block -timeout 60
bpremove $bp_6_6_fsbl_bp
targets -set -nocase -filter {name =~ "*R5*#0"}
rst -processor
dow C:/File/Lec/graduate/AAA708-Microprocessor-based-Systems-Design/Lab/Assignment2/sw/app_2/Debug/app_2.elf
